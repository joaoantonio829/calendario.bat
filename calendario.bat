@echo off
::aqui a baixo verifica se o mes é um numero de 1 a 12
if %2 gtr 12 (
    echo O mes deve ser um numero entre 1 e 12
    exit /b
)
:: aqui nesta parte cria um parametro
if not exist "%1" (
    mkdir "%1"
)
:: verifica se o ano é bissexto assim sabendo denominar se e ou nao
set /a "resto=%1 %% 4"
...
cd "%2"
:: aqui e definindo dias para cada mes
if "%2" == "1" set dias=31
